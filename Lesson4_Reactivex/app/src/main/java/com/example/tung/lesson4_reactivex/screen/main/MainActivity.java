...
import com.example.tung.lesson4_reactivex.data.api.ServiceGenerator;
import com.example.tung.lesson4_reactivex.data.model.User;
import com.example.tung.lesson4_reactivex.data.model.UserRepositoryImpl;
...
public class MainActivity extends AppCompatActivity implements MainContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter = new MainPresenter(this,
                UserRepositoryImpl.getInstance(ServiceGenerator.createService(GithubService.class)));
